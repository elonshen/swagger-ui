    ...
    return (
      <div className="opblock-section">
          ...
          {isOAS3 ? (
            <div className="tab-header">
              <div onClick={() => this.toggleTab("parameters")}
                ...
                <h4 className="opblock-title"><span>参数列表</span></h4>
              </div>
            ...
            <div className="tab-header">
              <h4 className="opblock-title">参数列表</h4>
            </div>
          )}
          {allowTryItOut ? (
            <TryItOutButton
        ...
        {this.state.parametersVisible ? <div className="parameters-container">
          {!groupedParametersArr.length ? <div className="opblock-description-wrapper"><p>无参数</p></div> :
            <div className="table-container">
              <table className="parameters">
                <thead>
                <tr>
                  <th className="col_header parameters-col_name">名称</th>
                  <th className="col_header parameters-col_description">描述</th>
                </tr>
                </thead>
                <tbody>
                {
        ...
        </div> : null}
        {
          ...
          <div className="opblock-section opblock-section-request-body">
            <div className="opblock-section-header">
              <h4 className={`opblock-title parameter__name ${requestBody.get("required") && "required"}`}>请求体</h4>
              <label id={controlId}>
                <ContentType
